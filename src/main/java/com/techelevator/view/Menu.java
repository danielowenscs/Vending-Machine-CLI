...
public class Menu {
	...
	public static void printMenu () {
		for (Map.Entry<Item,Integer> entry : menu.entrySet()) {
			if (entry.getValue() < 1) {
				System.out.println(entry.getKey().slotIdentifier + " | SOLD OUT");
			}
			else {
				System.out.println(entry.getKey().slotIdentifier + " | " + entry.getKey().getName());
			}
		}
	}


	private static void makeMenuItem (String line) {
